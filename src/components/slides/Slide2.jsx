    ...
    <div className="slide2-container">
      ...
      <div className="slide2-content">
        ...
        <div className="left-labels">
          ...
          <div className="label">
            <FaHandshake className="label-icon" />
            <div className="label-text">
        ...
        <div className="center-cards">
          <div className="benefit-card green">
            <FaRocket className="card-icon" size={30} color="#fff" />
            <span className="number">01</span>
          </div>
          <div className="benefit-card teal">
            <FaShieldAlt className="card-icon" size={30} color="#fff" />
            <span className="number">02</span>
          </div>
          <div className="benefit-card dark-teal">
            <FaSeedling className="card-icon" size={30} color="#fff" />
            <span className="number">03</span>
          </div>
          <div className="benefit-card dark">
            <FaHandshake className="card-icon" size={30} color="#fff" />
